...
const DeepPartial = (T) => (T instanceof Object
  ? {
      [P in Object.keys(T)]: DeepPartial(T[P]);
    }
  : T);

export { DeepPartial };

// Define the types using JavaScript
const LocaleType = en;
const PartialLocaleType = DeepPartial(en);
